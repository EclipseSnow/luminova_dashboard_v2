...
export interface PortfolioMarginAccountInfo3 {
  uniMMR: string;
...
export async function fetchPortfolioMarginAccountInfo3(): Promise<PortfolioMarginAccountInfo3> {
  ...
  try {
    ...
    return data as PortfolioMarginAccountInfo3;
  } catch (error) {
