...
export interface PortfolioMarginAccountInfoCyber1 {
  uniMMR: string;
...
export async function fetchPortfolioMarginAccountInfoCyber1(): Promise<PortfolioMarginAccountInfoCyber1> {
  ...
  try {
    ...
    return data as PortfolioMarginAccountInfoCyber1;
  } catch (error) {
