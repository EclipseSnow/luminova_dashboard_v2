export default function CyberXBinance02Details() {
  return (
    <div className="w-full p-4">
      <div className="bg-gray-50 shadow-md rounded-lg p-6">
        <h1 className="text-2xl font-bold mb-4">CyberX 币安 02 - Detailed View</h1>
        <p className="text-gray-600 mb-4">This is the detailed view for CyberX 币安 02 portfolio.</p>
